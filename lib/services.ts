...
export const services: Service[] = [
  {
    ...
    startingPrice: "$100",
    image: "/images/booking-reference.jpg",
    imageAlt: "Elegant lash appointment styling at CC & CO.",
    benefits: [
  ...
  },
  {
    ...
    startingPrice: "$150",
    image: "/images/aftercare-reference.jpg",
    imageAlt: "CC & CO aftercare guidance for lash and whitening clients.",
    benefits: [
      "Fuller lash line",
  ...
  },
  {
    ...
    startingPrice: "$70",
    image: "/images/price-list-reference.jpg",
    imageAlt: "CC & CO price list styling for lashes and whitening.",
    benefits: [
  ...
  },
  {
    ...
    startingPrice: "$300",
    image: "/images/booking-reference.jpg",
    imageAlt: "Professional beauty booking information at CC & CO.",
    benefits: [
      "Brighter smile",
  ...
  },
  {
    ...
    startingPrice: "$45",
    image: "/images/policy-reference.jpg",
    imageAlt: "CC & CO appointment policy styling.",
    benefits: [
  ...
  },
  {
    ...
    startingPrice: "$30",
    image: "/images/prices-circle-reference.jpg",
    imageAlt: "Minimal CC & CO prices graphic.",
    benefits: [
  ...
  },
  {
    ...
    image: "/images/aftercare-circle-reference.jpg",
    imageAlt: "Minimal CC & CO aftercare graphic.",
    benefits: [
